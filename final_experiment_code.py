...
def get_data(filename):
    ...
    #the motor moves 
    tau_values = t_to_tau(times)
    # this is the data set the rest of the code analyzes
    real_data = [tau_values, y_values]
    return real_data
...
def fit_to_fourier(data):
    ...
    #print(parameters)
    #fit_y = gauss(x, A, B,c)
    plt.plot(x*1e-12, y*1/2*1e-6, 'o', label='data', markersize=0.5)
...
def main():
    #file = "C:\\Users\\janet\\OneDrive\\Summer 2025 REU Project\\MokuDataLoggerData_sr_10khz_totvelocity_1.4_atot_8.csv"
    file = "C:\\Users\\janet\\OneDrive\\Summer 2025 REU Project\\CarvePulseTest_19700101_122432.csv"
    data = get_data(file)
    plot_data(data)
